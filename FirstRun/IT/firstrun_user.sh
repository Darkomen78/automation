...
# Delete launch file
rm -f ~/Library/LaunchAgents/com.infernobox.firstrun_user.plist

if [ "$USER" != "$ADMINUSR" ]; then
####################################	
...
/usr/bin/defaults write com.apple.dock 'persistent-apps' -array-add '<dict><key>tile-data</key><dict><key>file-data</key><dict><key>_CFURLString</key><string>/Applications/Notes.app/</string><key>_CFURLStringType</key><integer>0</integer></dict></dict></dict>'
...
/usr/bin/defaults write com.apple.dock 'persistent-apps' -array-add '<dict><key>tile-data</key><dict><key>file-data</key><dict><key>_CFURLString</key><string>/Applications/VLC.app/</string><key>_CFURLStringType</key><integer>0</integer></dict></dict></dict>'
...
/usr/bin/defaults write com.apple.dock 'persistent-apps' -array-add '<dict><key>tile-data</key><dict><key>file-data</key><dict><key>_CFURLString</key><string>/Applications/Adobe Photoshop C6/Adobe Photoshop C6.app/</string><key>_CFURLStringType</key><integer>0</integer></dict></dict></dict>'

/usr/bin/defaults write com.apple.dock 'persistent-apps' -array-add '<dict><key>tile-data</key><dict><key>file-data</key><dict><key>_CFURLString</key><string>/Applications/Adobe Illustrator C6/Adobe Illustrator.app/</string><key>_CFURLStringType</key><integer>0</integer></dict></dict></dict>'

/usr/bin/defaults write com.apple.dock 'persistent-apps' -array-add '<dict><key>tile-data</key><dict><key>file-data</key><dict><key>_CFURLString</key><string>/Applications/Adobe InDesign C6/Adobe InDesign C6.app/</string><key>_CFURLStringType</key><integer>0</integer></dict></dict></dict>'

/usr/bin/defaults write com.apple.dock 'persistent-apps' -array-add '<dict><key>tile-data</key><dict><key>file-data</key><dict><key>_CFURLString</key><string>/Applications/Adobe Acrobat X Pro/Adobe Acrobat Pro.app/</string><key>_CFURLStringType</key><integer>0</integer></dict></dict></dict>'

/usr/bin/defaults write com.apple.dock 'persistent-apps' -array-add '<dict><key>tile-data</key><dict><key>file-data</key><dict><key>_CFURLString</key><string>/Applications/Adobe Acrobat X Pro/Acrobat Distiller.app/</string><key>_CFURLStringType</key><integer>0</integer></dict></dict></dict>'

/usr/bin/defaults write com.apple.dock 'persistent-apps' -array-add '<dict><key>tile-data</key><dict><key>file-data</key><dict><key>_CFURLString</key><string>/Applications/EasyFind.app/</string><key>_CFURLStringType</key><integer>0</integer></dict></dict></dict>'
