...
osascript -e 'display notification "Configuration de la session administrateur en cours..."'
sleep 15

# Tweak System

# Désactive les popup de mise à jour Yosemite
/usr/libexec/PlistBuddy -c "Add :Disabled bool True" /System/Library/LaunchDaemons/com.apple.noticeboard.state.plist 
/usr/libexec/PlistBuddy -c "Add :Disabled bool True" /System/Library/LaunchAgents/com.apple.noticeboard.agent.plist
...
/usr/bin/defaults write com.apple.dock 'persistent-apps' -array-add '<dict><key>tile-data</key><dict><key>file-data</key><dict><key>_CFURLString</key><string>/Applications//Utilities/Managed Software Update.app/</string><key>_CFURLStringType</key><integer>0</integer></dict></dict></dict>'
...
/usr/bin/defaults write com.apple.dock 'persistent-others' -array-add "<dict><key>tile-data</key><dict><key>arrangement</key><integer>0</integer><key>displayas</key><integer>1</integer><key>file-data</key><dict><key>_CFURLString</key><string>/Applications/Utilities/Cliczone/</string><key>_CFURLStringType</key><integer>0</integer></dict><key>preferreditemsize</key><integer>-1</integer><key>showas</key><integer>3</integer></dict><key>tile-type</key><string>directory-tile</string></dict>"
